/* ════════════════════════════════════════════════════════════════════
   GROUP COMPANIES — Cinematic Industrial Hero behavior
...
(function () {
  ...
  const hero = document.querySelector('.gc-hero');
  if (!hero) return;

  const photo = hero.querySelector('.gc-hero-visual-img');
  const eyebrow = hero.querySelector('.gc-hero-eyebrow');
  const headingLines = hero.querySelectorAll('.gc-hero-heading .line');
  const desc = hero.querySelector('.gc-hero-desc');
  const cta = hero.querySelector('.gc-hero-cta');
  const features = hero.querySelector('.gc-hero-features');
  const featureItems = hero.querySelectorAll('.gc-hero-feature');
  const waveLine = hero.querySelector('.gc-hero-wave-line');
  ...
  // set in group-hero.css so the overflow:hidden wrapper never reveals
