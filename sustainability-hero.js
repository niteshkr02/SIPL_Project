/* ════════════════════════════════════════════════════════════════════
   ...
   (photo reveal → badge → headline lines → copy → CTA → five-item
   commitment row) and an extremely subtle scroll parallax on the
...
(function () {
  ...
  const hero = document.querySelector('.sush');
  if (!hero) return;

  const photo = hero.querySelector('.sush-visual-img');
  const badge = hero.querySelector('.sush-badge');
  const headingLines = hero.querySelectorAll('.sush-heading .line');
  const desc = hero.querySelector('.sush-desc');
  const cta = hero.querySelector('.sush-cta');
  const features = hero.querySelector('.sush-features');
  const featureItems = hero.querySelectorAll('.sush-feature');
  const featuresMobile = hero.querySelector('.sush-features-mobile');
  const featureItemsMobile = hero.querySelectorAll('.sush-feature-m');
